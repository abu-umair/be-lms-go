...
const (
	...
	CourseService_DetailCourse_FullMethodName = "/course.CourseService/DetailCourse"
	CourseService_EditCourse_FullMethodName   = "/course.CourseService/EditCourse"
...
type CourseServiceClient interface {
	...
	DetailCourse(ctx context.Context, in *DetailCourseRequest, opts ...grpc.CallOption) (*DetailCourseResponse, error)
...
func (c *courseServiceClient) DetailCourse(ctx context.Context, in *DetailCourseRequest, opts ...grpc.CallOption) (*DetailCourseResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(DetailCourseResponse)
	err := c.cc.Invoke(ctx, CourseService_DetailCourse_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *courseServiceClient) EditCourse(ctx context.Context, in *EditCourseRequest, opts ...grpc.CallOption) (*EditCourseResponse, error) {
	...
	err := c.cc.Invoke(ctx, CourseService_EditCourse_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CourseServiceServer interface {
	...
	DetailCourse(context.Context, *DetailCourseRequest) (*DetailCourseResponse, error)
...
func (UnimplementedCourseServiceServer) DetailCourse(context.Context, *DetailCourseRequest) (*DetailCourseResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DetailCourse not implemented")
}
func (UnimplementedCourseServiceServer) EditCourse(context.Context, *EditCourseRequest) (*EditCourseResponse, error) {
...
func _CourseService_DetailCourse_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DetailCourseRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CourseServiceServer).DetailCourse(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CourseService_DetailCourse_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CourseServiceServer).DetailCourse(ctx, req.(*DetailCourseRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _CourseService_EditCourse_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CourseService_EditCourse_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var CourseService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "DetailCourse",
			Handler:    _CourseService_DetailCourse_Handler,
		},
		{
