...
type BaseResponse struct {
	...
	ValidationErrors []*ValidationError     `protobuf:"bytes,4,rep,name=validation_errors,json=validationErrors,proto3" json:"validation_errors,omitempty"` //?  repeated = karena bisa lebih dari stu field validasi
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
