...
const (
	...
	StoreService_DetailStore_FullMethodName = "/store.StoreService/DetailStore"
	StoreService_EditStore_FullMethodName   = "/store.StoreService/EditStore"
...
type StoreServiceClient interface {
	...
	DetailStore(ctx context.Context, in *DetailStoreRequest, opts ...grpc.CallOption) (*DetailStoreResponse, error)
...
func (c *storeServiceClient) DetailStore(ctx context.Context, in *DetailStoreRequest, opts ...grpc.CallOption) (*DetailStoreResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(DetailStoreResponse)
	err := c.cc.Invoke(ctx, StoreService_DetailStore_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *storeServiceClient) EditStore(ctx context.Context, in *EditStoreRequest, opts ...grpc.CallOption) (*EditStoreResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(EditStoreResponse)
	err := c.cc.Invoke(ctx, StoreService_EditStore_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type StoreServiceServer interface {
	...
	DetailStore(context.Context, *DetailStoreRequest) (*DetailStoreResponse, error)
...
func (UnimplementedStoreServiceServer) DetailStore(context.Context, *DetailStoreRequest) (*DetailStoreResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DetailStore not implemented")
}
func (UnimplementedStoreServiceServer) EditStore(context.Context, *EditStoreRequest) (*EditStoreResponse, error) {
...
func _StoreService_DetailStore_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DetailStoreRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(StoreServiceServer).DetailStore(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: StoreService_DetailStore_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StoreServiceServer).DetailStore(ctx, req.(*DetailStoreRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _StoreService_EditStore_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(EditStoreRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(StoreServiceServer).EditStore(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: StoreService_EditStore_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StoreServiceServer).EditStore(ctx, req.(*EditStoreRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var StoreService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _StoreService_DetailStore_Handler,
		},
		{
			MethodName: "EditStore",
			Handler:    _StoreService_EditStore_Handler,
		},
		{
